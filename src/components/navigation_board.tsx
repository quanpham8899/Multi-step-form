...
const NavigationBoard: React.FC<ButtonListProps> = ({ data }) => {
  const [navButtons, setNavButtons] = React.useState<NavButtonProps[]>(data)
  ...
  return (
    <div
      className={`background-desktop ${width >= 1280 ? "background-desktop" : "background-mobile"} pt-10 rounded-lg m-1 flex 
